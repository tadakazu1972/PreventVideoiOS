...
//  PreventVideoiOS
//
//  Created by Osaka City on 2018/07/02.
//  Copyright © 2018年 Osaka City. All rights reserved.
//
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        btnOutlet.addTarget(self, action: #selector(self.playMovieFromProjectBundle1), for: .touchUpInside)
        ...
        btnStove.addTarget(self, action: #selector(self.playMovieFromProjectBundle2), for: .touchUpInside)
        ...
        btn3.addTarget(self, action: #selector(self.playMovieFromProjectBundle3), for: .touchUpInside)
        ...
        btn4.addTarget(self, action: #selector(self.playMovieFromProjectBundle4), for: .touchUpInside)
        ...
        btn5.addTarget(self, action: #selector(self.playMovieFromProjectBundle5), for: .touchUpInside)
        ...
        btn6.addTarget(self, action: #selector(self.playMovieFromProjectBundle6), for: .touchUpInside)
        ...
        btn7.addTarget(self, action: #selector(self.playMovieFromProjectBundle7), for: .touchUpInside)
        ...
        btn8.addTarget(self, action: #selector(self.playMovieFromProjectBundle8), for: .touchUpInside)
    ...
    //アプリ内に組み込んだ動画ファイルを再生
    @objc func playMovieFromProjectBundle1(){
        
        if let bundlePath = Bundle.main.path(forResource: "outlet", ofType: "mp4"){
    ...
    //アプリ内に組み込んだ動画ファイルを再生
    @objc func playMovieFromProjectBundle2(){
        
        if let bundlePath = Bundle.main.path(forResource: "stove", ofType: "mp4"){
    ...
    //アプリ内に組み込んだ動画ファイルを再生
    @objc func playMovieFromProjectBundle3(){
        
        if let bundlePath = Bundle.main.path(forResource: "tobacco", ofType: "mp4"){
    ...
    //アプリ内に組み込んだ動画ファイルを再生
    @objc func playMovieFromProjectBundle4(){
        
        if let bundlePath = Bundle.main.path(forResource: "tempura", ofType: "mp4"){
    ...
    //アプリ内に組み込んだ動画ファイルを再生
    @objc func playMovieFromProjectBundle5(){
        
        if let bundlePath = Bundle.main.path(forResource: "hotiki", ofType: "mp4"){
    ...
    //アプリ内に組み込んだ動画ファイルを再生
    @objc func playMovieFromProjectBundle6(){
        
        if let bundlePath = Bundle.main.path(forResource: "cloth", ofType: "mp4"){
    ...
    //アプリ内に組み込んだ動画ファイルを再生
    @objc func playMovieFromProjectBundle7(){
        
        if let bundlePath = Bundle.main.path(forResource: "oxy_tobacco", ofType: "mp4"){
    ...
    //アプリ内に組み込んだ動画ファイルを再生
    @objc func playMovieFromProjectBundle8(){
        
        if let bundlePath = Bundle.main.path(forResource: "room", ofType: "mp4"){
